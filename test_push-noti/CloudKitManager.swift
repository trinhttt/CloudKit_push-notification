...
class CloudKitManager {
    ...
    // Can delete recordType: String from the method
    ...
    func modifyRecordsForReal(_ records: [CKRecord], with IDs: [CKRecordID], perRecordCompletion: ((_ record: CKRecord?, _ error: Error?) -> Void)?, completion: ((_ records: [CKRecord]?, _ error: Error?) -> Void)?) {
        ...
        operation.modifyRecordsCompletionBlock = { (records, recordIDs, error) -> Void in (completion?(records, error))! }
